...
//import view.GameFrame.GameState;
import view.GameFrame;
public class World {

	private Random rd;

	public ButtonPlay[][] arrayButton;
	public int[][] arrayMin;// Boom là số -1
	...
	public World(int w, int h, int boom, GamePanel game, GameFrame gameFrame) {
	...
	public boolean open(int i, int j) {
		...
		if (!isComplete && !isEnd) {
			if (!arrayBoolean[i][j]) {
				if (arrayMin[i][j] == 0) {
//					game.gameFrame.gameState.push(GameState.Multi);
//					game.gameFrame.getPosForMulti(i, j);
					game.gameFrame.getPos(i, j);
...
//									game.gameFrame.getPosForMulti(i, j);									
									open(l, k);
//									System.out.println("Muti open at: " + l + " " + k);					
					...
					if (number != -1) {
						game.gameFrame.getPos(i, j);
//						game.gameFrame.gameState.push(GameState.Single);
//						game.gameFrame.getPosForSingle(i, j);				
						arrayBoolean[i][j] = true;
//						System.out.println("Single open at " + i + " " + j);
