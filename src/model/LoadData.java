...
public class LoadData {
	...
	public LoadData() {
		...
		try {
			...
			listImage.put("title", img.getSubimage(0, 138, 141, 126));
			...
			listImage.put("smile", img.getSubimage(0, 270, 97, 96));
			listImage.put("smilePress", img.getSubimage(113, 269, 95, 97));
			listImage.put("smilePressPlay", img.getSubimage(113, 269, 95, 97));
			listImage.put("smileLose", img.getSubimage(0, 374, 97, 94));
			listImage.put("smileWin", img.getSubimage(109, 373, 95, 92));
